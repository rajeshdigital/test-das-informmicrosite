module.exports = {
    bind: function(app, assetPath) {
        ...
        app.get('/layout/example-grid-layout', function(req, res) {
            ...
            res.render('examples/example_grid_layout', {
                'section': section,
        ...
        app.get('/typography/example-typography', function(req, res) {
            ...
            res.render('examples/example_typography', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/typography/example-details-summary', function(req, res) {
            ...
            res.render('examples/example_details_summary', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/icons-images/example-icons', function(req, res) {
            ...
            res.render('examples/example_icons', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/form-elements', function(req, res) {
            ...
            res.render('guide_form_elements', {
                'page_name': pageName
            })
        })
        ...
        app.get('/form-elements/example-forms', function(req, res) {
            ...
            res.render('examples/example_forms', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/form-elements/example-date', function(req, res) {
            ...
            res.render('examples/example_date', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/form-elements/example-radios-checkboxes', function(req, res) {
            ...
            res.render('examples/example_radios_checkboxes', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/form-elements/example-form-elements', function(req, res) {
            ...
            res.render('examples/example_form_elements', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/errors/example-form-validation-single-question-radio', function(req, res) {
            ...
            res.render('examples/example_form_validation_single_question_radio', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
        ...
        app.get('/errors/example-form-validation-multiple-questions', function(req, res) {
            ...
            res.render('examples/example_form_validation_multiple_questions', {
                'section': section,
                'section_name': sectionName,
                'page_name': pageName
            })
